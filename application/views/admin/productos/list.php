                                ...
                                <?php if(!empty($productos)):?>
                                    <?php foreach($productos as $producto):?>
                                        <tr>
                                            ...
                                            <?php $dataproducto = $producto->id."*".$producto->nombre."*".$producto->marca."*".$producto->talle."*".$producto->color."*".$producto->precio."*".$producto->detalle."*".$producto->estado."*".$producto->categoria_id;?>
                                            <td>
                                                <div class="btn-group">
